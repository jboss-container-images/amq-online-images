SUBDIRS=standard-controller address-space-controller agent mqtt-gateway mqtt-lwt router router-metrics topic-forwarder none-authservice auth-controller auth-server api-server service-broker
