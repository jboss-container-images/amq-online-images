SUBDIRS=standard-controller address-space-controller agent mqtt-gateway mqtt-lwt router topic-forwarder auth-controller auth-plugin api-server service-broker
